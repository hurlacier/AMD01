...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 25 fév. 2019 à 22:27
...
--
ALTER TABLE `abonne`
  MODIFY `id_abonne` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `emprunt`
--
ALTER TABLE `emprunt`
  MODIFY `id_emprunt` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `livre`
--
ALTER TABLE `livre`
  MODIFY `id_livre` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
